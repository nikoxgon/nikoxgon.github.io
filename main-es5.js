...
var map = {
	"./rendidor/galeria/detalle/detalle.module": [
		"./src/app/rendidor/galeria/detalle/detalle.module.ts",
		"common",
		"rendidor-galeria-detalle-detalle-module"
	],
	"./rendidor/gastos/editar/editar.module": [
		"./src/app/rendidor/gastos/editar/editar.module.ts",
		"common",
		"rendidor-gastos-editar-editar-module"
	]
};
...
var routes = [
    {
        path: '',
        loadChildren: function () { return Promise.all(/*! import() | rendidor-rendidor-module */[__webpack_require__.e("common"), __webpack_require__.e("rendidor-rendidor-module")]).then(__webpack_require__.bind(null, /*! ./rendidor/rendidor.module */ "./src/app/rendidor/rendidor.module.ts")).then(function (m) { return m.RendidorPageModule; }); }
    },
    {
        path: 'aprobador',
        loadChildren: function () { return __webpack_require__.e(/*! import() | aprobador-aprobador-module */ "aprobador-aprobador-module").then(__webpack_require__.bind(null, /*! ./aprobador/aprobador.module */ "./src/app/aprobador/aprobador.module.ts")).then(function (m) { return m.AprobadorPageModule; }); }
    },
    {
        path: 'administrador',
    ...
    { path: 'editar', loadChildren: './rendidor/gastos/editar/editar.module#EditarPageModule' },
    { path: 'detalle', loadChildren: './rendidor/galeria/detalle/detalle.module#DetallePageModule' },
];
...
/* harmony import */ var _ionic_native_blinkid_ngx__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @ionic-native/blinkid/ngx */ "./node_modules/@ionic-native/blinkid/ngx/index.js");
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [_app_component__WEBPACK_IMPORTED_MODULE_9__["AppComponent"], _perfil_perfil_component__WEBPACK_IMPORTED_MODULE_10__["PerfilPopover"]],
            entryComponents: [_perfil_perfil_component__WEBPACK_IMPORTED_MODULE_10__["PerfilPopover"]],
            imports: [
            ...
            providers: [
                ...
                _ionic_native_blinkid_ngx__WEBPACK_IMPORTED_MODULE_7__["BlinkId"],
...
/*!********************************************!*\
  !*** ./src/app/perfil/perfil.component.ts ***!
  \********************************************/
/*! exports provided: PerfilPopover */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PerfilPopover", function() { return PerfilPopover; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
...
var PerfilPopover = /** @class */ (function () {
    function PerfilPopover(router) {
        this.router = router;
        this.radio_list = [
            {
                id: '1',
    ...
    PerfilPopover.prototype.ngOnInit = function () {
        var _this = this;
        this.id_perfil = localStorage.getItem('perfil');
        this.radio_list
            .filter(function (val) { return val.value === _this.id_perfil; })
            .map(function (val) { return val.checked = true; });
    };
    PerfilPopover.prototype.changePerfil = function (e) {
        var id = Number(e.detail.value);
        if (id === 1) {
            localStorage.setItem('perfil', '1');
            this.router.navigate(['/rendidor']);
        }
        else if (id === 2) {
    ...
    PerfilPopover.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] }
    ]; };
    PerfilPopover = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'app-perfil',
            template: "\n    <ion-list no-margin lines=\"none\">\n        <ion-list-header>Perfiles disponibles</ion-list-header>\n        <ion-radio-group (ionChange)=\"changePerfil($event)\">\n            <ion-item *ngFor=\"let item of radio_list\">\n                <ion-icon src=\"./assets/icons/{{ item.icon }}.svg\" slot=\"start\"></ion-icon>\n                <ion-label> {{ item.text }}</ion-label>\n                <ion-radio slot=\"end\" [value]=\"item.value\" [checked]=\"item.checked\"></ion-radio>\n            </ion-item>\n        </ion-radio-group>\n        <ion-button expand=\"block\">Cerrar Sesion</ion-button>\n    </ion-list>\n  "
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"]])
    ], PerfilPopover);
    return PerfilPopover;
}());
...
module.exports = __webpack_require__(/*! C:\Users\Nico\Documents\GitHub\RindeRapido_Front_Mobile\src\main.ts */"./src/main.ts");
